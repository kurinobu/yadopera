...
**テンプレートの入手**:
- FAQ管理画面の「CSV一括登録」モーダル内にある「テンプレートダウンロード」リンクから、4言語（日本語・英語・フランス語・繁体中国語）の推奨テンプレートをダウンロードできます。マニュアルのこの節からも [CSVテンプレートをダウンロード](/faq-csv-template/FAQ_CSV_template_4lang.csv) できます
