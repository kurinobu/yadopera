...
**料金体系の概要**:
- **Free**: 1言語、無料、月30質問まで、FAQ 30件
- **Mini**: 2言語、¥1,980/月、質問は従量（¥30/質問）、FAQ 30件
- **Small**: 3言語、¥3,980/月、200質問まで（超過分は¥30/質問）、FAQ 50件
- **Standard**: 4言語、¥5,980/月、500質問まで（超過分は¥30/質問）、FAQ 100件
- **Premium**: 言語無制限、¥7,980/月、1,000質問まで（超過分は¥30/質問）、FAQ 無制限`
      },
      {
