...
const STR_JA: EscalationGuestStrings = {
  ...
  successBody: (n) =>
    `お問い合わせを受け付けました。受付番号は ${n} です。このあと、スタッフが内容を確認します。`,
  close: '閉じる',
...
const STR_EN: EscalationGuestStrings = {
  ...
  successBody: (n) =>
    `We have received your request. Your reference number is ${n}. Staff will review your message.`,
  close: 'Close',
...
const STR_ZH_TW: EscalationGuestStrings = {
  ...
  sending: '傳送中…',
  successTitle: '已收到通知',
  successBody: (n) => `我們已收到您的聯絡。受理編號為 ${n}。工作人員將會檢視內容。`,
  close: '關閉',
...
const STR_ZH_CN: EscalationGuestStrings = {
  ...
  sending: '发送中…',
  successTitle: '已收到',
  successBody: (n) => `我们已收到您的联络。受理编号为 ${n}。工作人员将查看内容。`,
  close: '关闭',
...
const STR_FR: EscalationGuestStrings = {
  ...
  successBody: (n) =>
    `Nous avons bien reçu votre message. Votre numéro de suivi est ${n}. Le personnel va le consulter.`,
  close: 'Fermer',
...
const STR_ES: EscalationGuestStrings = {
  ...
  successBody: (n) =>
    `Hemos recibido su mensaje. Su número de referencia es ${n}. El personal lo revisará.`,
  close: 'Cerrar',
...
const STR_KO: EscalationGuestStrings = {
  ...
  successBody: (n) =>
    `문의가 접수되었습니다. 접수 번호는 ${n} 입니다. 직원이 내용을 확인합니다.`,
  close: '닫기',
...
const STR_TH: EscalationGuestStrings = {
  ...
  successBody: (n) => `เราได้รับคำขอของคุณแล้ว หมายเลขอ้างอิงคือ ${n} เจ้าหน้าที่จะตรวจสอบข้อความ`,
  close: 'ปิด',
