...
1. **市場規模・地域拡大戦略**: 段階的拡大計画明確化（Phase 2: 福岡・沖縄、Phase 3: 北海道・金沢）、潜在市場500-1000施設
...
**結果に基づきPhase 2の言語優先度を決定**（英語以外の第1優先言語）
...
**Operator Support API（Phase 2）**★新規
...
- **地域拡大**: 福岡・沖縄への営業開始
- **宿泊事業者向けAIヘルプチャット実装**★新規
  - 管理画面内フローティングチャット
  - 事業者向けFAQ（20-30項目）をRAG/System Prompt埋め込み
  - 設定画面リンク自動返却
  - サポート工数70%削減目標
- 通知機能強化: Slack/LINE連携
...
| v0.3 | 2025-11-21 | 市場拡大戦略、PoC施設数最適化、FAQ自動学習MVP化、夜間対応設計、信頼度スコア改善、セッション統合、収益モデル多様化、安全カテゴリ強制エスカレーション、競合モニタリング体制、**宿泊事業者向けFAQ＋AIサポート（Phase 2）**、データ保持ポリシー詳細化 |
