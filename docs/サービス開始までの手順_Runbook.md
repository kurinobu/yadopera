...
**作成日**: 2026年3月19日  
**最終更新日**: 2026年3月27日（A完了・本番 Alembic 023 適用記録を追記）  
...
**Status**: A（FAQ上限制御）を本番まで完了。`main` 反映後に本番DBの Alembic `022 -> 023` を適用し、Free の `faq_limit=30` を確認。ステージング・本番ともに 31件目拒否が「30件まで」で一致。
