...
class TestAuthFlow:
    ...
    @pytest.mark.asyncio
    async def test_login_and_access_protected_endpoint(self, client, test_user):
...
class TestChatFlow:
    ...
    async def test_chat_history_flow(self, client, db_session, test_facility):
        ...
        # API呼び出し
        response = await client.get(f"/api/v1/chat/history/integration-test-session")
...
class TestAdminFlow:
    ...
    @pytest.mark.asyncio
    async def test_dashboard_access(self, client, auth_headers):
        """ダッシュボードアクセステスト"""
    ...
    @pytest.mark.asyncio
    async def test_faq_list_access(self, client, auth_headers):
        """FAQ一覧取得テスト"""
        response = await client.get("/api/v1/admin/faqs", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_faq_suggestions_access(self, client, auth_headers):
        """FAQ提案一覧取得テスト"""
        response = await client.get("/api/v1/admin/faq-suggestions", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_overnight_queue_access(self, client, auth_headers):
        """夜間対応キューアクセステスト"""
        response = await client.get("/api/v1/admin/overnight-queue", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_qr_code_generation_access(self, client, auth_headers):
        """QRコード生成アクセステスト"""
...
class TestResponseTime:
    ...
    @pytest.mark.asyncio
    async def test_dashboard_response_time(self, client, auth_headers):
        """ダッシュボードレスポンス速度テスト"""
        import time
    ...
    @pytest.mark.asyncio
    async def test_faq_list_response_time(self, client, auth_headers):
        """FAQ一覧レスポンス速度テスト"""
        import time
